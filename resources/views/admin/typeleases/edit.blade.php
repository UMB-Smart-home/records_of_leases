        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.typelease.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.typeleases.update", [$typelease->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('typ_prenajmu') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="typ_prenajmu" id="typ_prenajmu" value="{{ old('typ_prenajmu', $typelease->typ_prenajmu) }}">
