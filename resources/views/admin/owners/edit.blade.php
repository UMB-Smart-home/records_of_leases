                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.owners.update", [$owner->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $owner->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('surname') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="surname" id="surname" value="{{ old('surname', $owner->surname) }}" required>
