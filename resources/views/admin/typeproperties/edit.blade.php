        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.typeproperty.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.typeproperties.update", [$typeproperty->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('typ_bytu') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="typ_bytu" id="typ_bytu" value="{{ old('typ_bytu', $typeproperty->typ_bytu) }}" required>
