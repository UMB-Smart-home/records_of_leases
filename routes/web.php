...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Non Cruds
    Route::resource('non-cruds', 'NonCrudController', ['except' => ['create', 'store', 'edit', 'update', 'show', 'destroy']]);

    // Typeproperties
    Route::delete('typeproperties/destroy', 'TypepropertyController@massDestroy')->name('typeproperties.massDestroy');
    Route::resource('typeproperties', 'TypepropertyController');

    // Typeleases
    Route::delete('typeleases/destroy', 'TypeleasesController@massDestroy')->name('typeleases.massDestroy');
    Route::resource('typeleases', 'TypeleasesController');

    // Leases
    Route::delete('leases/destroy', 'LeasesController@massDestroy')->name('leases.massDestroy');
